...
figma.ui.onmessage = msg => {
    ...
    if (msg.type === 'create-grid') {
        const LINE_COLOR_A = { r: 0.73, g: 0.023, b: 0.56, a: 1 };
        const { a } = LINE_COLOR_A, LINE_COLOR = __rest(LINE_COLOR_A, ["a"]);
        const DROP_SHADOW = [{ type: 'DROP_SHADOW', color: LINE_COLOR_A, offset: { x: 0, y: 0 }, radius: 3, visible: true, blendMode: 'NORMAL' }];
        const nodes = [];
